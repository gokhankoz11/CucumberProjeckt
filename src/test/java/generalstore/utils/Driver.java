...
public class Driver {
 ...
 //          }
            ...
            driver = new AndroidDriver(service.getUrl(), options);  //  driver = new AndroidDriver(url, options);
...
// github adresi  https://github.com/gurkaybirinci/AppiumTestNGFramework.git